...
"""Workspace-wide values of the alloy-hardforks project, derived from its root Cargo.toml."""

# What every crate of the project inherits; see //bazel:rust.bzl.
WORKSPACE = struct(
    name = "alloy-hardforks",
    manifest = "//alloy-hardforks:Cargo.toml",
    lints = "//alloy-hardforks/bazel:lints",
    edition = "2024",
    version = "0.4.8",
)
