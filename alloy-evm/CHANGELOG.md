...
## [0.39.0](https://github.com/alloy-rs/evm/releases/tag/v0.39.0) - 2026-08-26

### Dependencies

- Bump revm to 43.0.0 ([#403](https://github.com/alloy-rs/evm/issues/403))

### Features

- [evm] Support transaction environment downcasting ([#397](https://github.com/alloy-rs/evm/issues/397))

## [0.38.0](https://github.com/alloy-rs/evm/releases/tag/v0.38.0) - 2026-07-31

### Dependencies

- Bump revm to 42.0.1 + EIP-8282 system calls ([#396](https://github.com/alloy-rs/evm/issues/396))

### Features

- [evm] Support database adapters ([#395](https://github.com/alloy-rs/evm/issues/395))
...
- Set rust-toolchain inputs explicitly ([#388](https://github.com/alloy-rs/evm/issues/388))
...
- Downgrade precompile span to trace ([#367](https://github.com/alloy-rs/evm/issues/367))
